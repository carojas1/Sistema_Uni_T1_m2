...
const { PrismaClient } = require(join(process.cwd(), 'prisma/generated/client-support'));

@Injectable()
export class PrismaSupportService extends (PrismaClient as { new(options?: any): PrismaClientType }) implements OnModuleInit, OnModuleDestroy {
    constructor() {
        const pool = new Pool({
