...
const { PrismaClient } = require(join(process.cwd(), 'prisma/generated/client-auth'));

@Injectable()
export class PrismaAuthService extends (PrismaClient as { new(options?: any): PrismaClientType }) implements OnModuleInit, OnModuleDestroy {
    constructor() {
        const pool = new Pool({
